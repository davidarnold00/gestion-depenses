...
$stats_query = $conn->query("SELECT categorie, SUM(montant) as somme FROM depenses GROUP BY categorie");
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
    <div class="container">
        <a class="navbar-brand fw-bold" href="index.php"><i class="bi bi-wallet2 me-2"></i>SpendWise</a>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="ajouter.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary w-100 fw-bold">Valider l'achat</button>
                    </form>
                </div>
            </div>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
                        <?php while($s = $stats_query->fetch_assoc()): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center small">
                            <?= $s['categorie'] ?>
                            <span class="badge bg-light text-dark border"><?= number_format($s['somme'], 2) ?> €</span>
                        </li>
                        <?php endwhile; ?>
                        <li class="list-group-item text-center fw-bold text-success fs-5">
                    ...
                    <tbody>
                        ...
                        <tr class="align-middle">
                            ...
                            <td>
                                ...
                                <span class="badge bg-secondary-subtle text-secondary small"><?= $row['categorie'] ?></span>
                            </td>
                            <td class="text-end amount-badge"><?= number_format($row['Montant'], 2) ?> €</td>
